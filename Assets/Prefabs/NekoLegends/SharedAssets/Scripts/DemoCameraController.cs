...
namespace NekoLegends
{
    public class DemoCameraController : MonoBehaviour
    {
        ...
        [SerializeField] public bool FixedDOF;
        ...
        private float transitionDuration = 1.0f; // Default transition duration
        ...
        /// <summary>
        /// Initiates a smooth transition to a new target's x position.
        /// </summary>
        /// <param name="newTarget">The new target to transition to.</param>
        ...
        private IEnumerator CameraTransitionCoroutine()
        {
            while (transitionElapsed < transitionDuration)
            {
                ...
                // Only interpolate the x component
            ...
            // Ensure the final x offset is set
        ...
        {
            // Transition is handled by the coroutine, so no need to do anything here
        }

        #endregion

        // Example method to trigger transition from DemoCameraScene
        ...
        protected void AdjustDOFForTarget(Transform autoDOFTarget)
        {
